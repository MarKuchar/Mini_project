...
public class GameAlternative {
    ...
    public static void guessLetter () {
        ...
        do {
            ...
            if (!(letter >= 65 && letter <= 122 && input.length() < 2)) {
                ...
                /*
                 * if I want to add either lower and upper case
    ...
    public static boolean revealLetter () {
        ...
        System.out.println("You have guessed ("+numOfGuesses+") wrong letters:");
        return false;
    }
}